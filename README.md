...
✧ The file `api_keys.yaml` contains the complete list of your API keys that need to be added to your shared node during the deployment process using the `idena_shared.yaml` playbook;
